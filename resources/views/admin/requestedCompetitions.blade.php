    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">New Competitions Requests</h2>
                </div>
            </div>
                    ...
                    @foreach($newCompetitions as $competition)
                        <tr>
                            ...
                            <td style="width: 5%">{{$competition->fromDate}}-{{$competition->toDate}}</td>
                                ...
                                <td style="width: 5%"><span class="badge badge-info">{{$competition->status}}</span>
                                </td>
                            ...
                            <td style="width: 5%"> <img src="{{asset('adImagesFolder/'.$competition->imageUrl)}}"  width="220" height="230" alt="Smiley face"></td>
                                ...
                                <td style="width: 5%"><a class="btn btn-success btn-sm" type="submit"  href="{{route('getCompetitionDetail', $competition -> id)}}" >Detail</a></td>
