    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">All Categories</h2>
                </div>
                <div>
                    <a href="{{ url('/add-category')}}" class="btn btn-outline-info btn-sm mb-2 mr-3">Add Category</a>
                </div>
            </div>
            <div class="m-datatable">
                <table id="datatable" class="table table-striped">
                    ...
                    @foreach($categories as $cat)
                        <tr>
                            <td><a class="link-info">{{$cat->name}}</a></td>

{{--                            <td>{{$company->incomeFrom}}-{{$company->incomeTo}}</td>--}}
{{--                            <td>{{$company->category->name}}</td>--}}
{{--                            <td>{{$company->status}}</td>--}}
{{--                            <td><img  src="{{asset('adImagesFolder/'.$company->profilePicUrl)}}"  width="220" height="230" alt="Smiley face"></td>--}}
                        </tr>
                    @endforeach
                    </tbody>
                </table>
