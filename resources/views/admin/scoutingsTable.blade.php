    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">All Scoutings</h2>
                </div>
            </div>
            <div class="m-datatable">
                <table id="datatable" class="table table-striped">
                    ...
                    <tr>
                        {{--<td><a href="#" class="link-info">St</a></td>--}}
                        <td>{{$scouting->fromDate}}</td>
                        <td>{{$scouting->toDate}}</td>
                        <td>{{$scouting->category->name}}</td>
                        {{--<td>2011/04/25</td>--}}
                        {{--<td>$320,800</td>--}}
                    </tr>
                   @endforeach
