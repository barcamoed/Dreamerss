    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">All Artists</h2>
                </div>
            </div>
            <div class="m-datatable">
                <table id="datatable" class="table table-striped">
                    ...
                    <tr>
                        <td><a class="link-info">{{$artist->username}}</a></td>
                        <td>{{$artist->email}}</td>
                        <td>{{$artist->gender}}</td>
                        <td>{{$artist->age}}</td>
                        <td>{{$artist->status}}</td>
                        <td><img  src="{{asset('adImagesFolder/'.$artist->profilePicUrl)}}"  width="220" height="230" alt="Smiley face"></td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
