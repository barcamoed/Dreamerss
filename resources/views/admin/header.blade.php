...
<div class="navbar navbar-light navbar-expand-lg">
    ...
    <a href="/"><img src="{{ asset('img/logo.png') }}" alt="" class="navbar-brand__logo"></a>
    {{--<span class="ua-icon-menu slide-nav-toggle"></span>--}}
  </span>

    <span class="navbar-brand-sm">
    <a href="/"><img src="{{ asset('img/logo-sm.png') }}" alt="" class="navbar-brand__logo"></a>
    <span class="ua-icon-menu slide-nav-toggle"></span>
  </span>
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
        ...
        <span class="navbar-notify navbar-notify--notifications">
          <span>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-notifications">
                ...
                <div class="navbar-dropdown-notifications__body js-scrollable">
                    ...
                    <div class="navbar-dropdown-notification is-new">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-4.png') }}" alt="" width="40" height="40">
                    ...
                    <div class="navbar-dropdown-notification">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-5.png') }}"  alt="" width="40" height="40">
                    ...
                    <div class="navbar-dropdown-notification">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-6.png') }}" alt="" width="40" height="40">
                    ...
                    <div class="navbar-dropdown-notification">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-7.png') }}" alt="" width="40" height="40">
                            <div class="ua-icon-circle-check navbar-dropdown-notification__icon color-success"></div>
                        </div>
                        <div class="navbar-dropdown-notification__content">
                            <a href="#" class="navbar-dropdown-notification__action-name">Antonius in Project X </a>
                    ...
                    <div class="navbar-dropdown-notification">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-8.png') }}" alt="" width="40" height="40">
                            <div class="ua-icon-letter-alt navbar-dropdown-notification__icon color-danger navbar-dropdown-notification__icon--letter"></div>
                        </div>
                        <div class="navbar-dropdown-notification__content">
                            <a href="#" class="navbar-dropdown-notification__action-name">Antonius in Project X </a>
                    ...
                    <div class="navbar-dropdown-notification">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-9.png') }}" alt="" width="40" height="40">
                            <div class="ua-icon-warning navbar-dropdown-notification__icon color-warning navbar-dropdown-notification__icon--warning"></div>
                        </div>
                        <div class="navbar-dropdown-notification__content">
                            <a href="#" class="navbar-dropdown-notification__action-name">Antonius in Project X </a>
                    ...
                    <div class="navbar-dropdown-notification">
                        <div class="navbar-dropdown-notification__user">
                            <img class="navbar-dropdown-notification__avatar rounded-circle" src="{{ asset('img/users/user-10.png') }}" alt="" width="40" height="40">
                            <div class="ua-icon-circle-check navbar-dropdown-notification__icon color-success"></div>
                        </div>
                        <div class="navbar-dropdown-notification__content">
                            <a href="#" class="navbar-dropdown-notification__action-name">Antonius in Project X </a>
                ...
                <a class="navbar-dropdown-notifications__view-all" href="#"><span class="icon ua-icon-view-all"></span><span></span></a>
            </div>
        </div>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-notifications navbar-dropdown-messages">
                ...
                <div class="navbar-dropdown-notifications__body navbar-dropdown-notifications__body-messages js-scrollable">
                    <div class="navbar-dropdown-notifications__item is-unread">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle" src="{{ asset('img/users/user-4.png') }}"  alt="" width="40" height="40"/>
                    ...
                    <div class="navbar-dropdown-notifications__item">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle"  src="{{ asset('img/users/user-5.png') }}" alt="" width="40" height="40"/>
                        <div class="navbar-dropdown-notifications__item-notify">
                            <div>
                    ...
                    <div class="navbar-dropdown-notifications__item is-unread">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle" src="{{ asset('img/users/user-6.png') }}" alt="" width="40" height="40"/>
                        <div class="navbar-dropdown-notifications__item-notify">
                            <div>
                    ...
                    <div class="navbar-dropdown-notifications__item is-unread">
                        <img class="navbar-dropdown-notifications__item-avatar rounded-circle"  src="{{ asset('img/users/user-7.png') }}" alt="" width="40" height="40"/>
                        <div class="navbar-dropdown-notifications__item-notify">
                            <div>
                ...
                </div><a class="navbar-dropdown-notifications__view-all" href="{{ url('/messenger')}}"><span class="icon ua-icon-view-all"></span><span>View all  </span></a>
            </div>
        </div>
        ...
        <div class="dropdown navbar-dropdown">
            <a class="dropdown-toggle navbar-dropdown-toggle navbar-dropdown-toggle__user" data-toggle="dropdown" >
                ...
                {{--{{App\Admin::getAdminProfilePic()}}--}}
                <img  alt="" src="{{asset('adImagesFolder/'.App\Admin::getAdminProfilePic())}}" class="navbar-dropdown-toggle__user-avatar">
                <span class="navbar-dropdown__user-name">{{\Illuminate\Support\Facades\Auth::user()->name}}</span>
            </a>
            <div class="dropdown-menu navbar-dropdown-menu navbar-dropdown-menu__user">
                <div class="navbar-dropdown-user-content">
                    <div class="dropdown-user__avatar">
                        <img src="{{asset('adImagesFolder/'.App\Admin::getAdminProfilePic())}}" alt=""/>
                    </div>
