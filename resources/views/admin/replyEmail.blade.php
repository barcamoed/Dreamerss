...
<div class="container-fluid">
  ...
  <div class="main-container">
    ...
    <div class="row">
      <div class="col-5">
        {{--<h4>Default</h4>--}}
        <form method="POST" role="form" enctype="multipart/form-data" action="{{ route('sendReplyEmail') }}">
        <div class="input-group input-group-icon icon-right">
          {{--<label style="margin-right: 1% ">To:</label>--}}
          <input class="form-control" value="{{$contact->email}}" name="email" placeholder="Enter email">
        ...
        {{--</div>--}}
        <div class="input-group input-group-icon icon-right">
          {{--<label style="margin-right: 1% ">Subject:</label>--}}
          <input class="form-control" value="{{$contact->subject}}" name="subject" placeholder="Subject">
          <span class="input-icon ua-icon-bag-outline"></span>
        </div>
        <div class="col-12">
        <h4>Textarea</h4>
        <div class="form-group">
        <textarea rows="5" placeholder="Type Message" name="message" class="form-control"></textarea>
        </div>
