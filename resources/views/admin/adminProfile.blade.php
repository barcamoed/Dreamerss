...
<div class="page-wrap">
    ...
    <div class="page-content">
        ...
        <div class="main-container">
            {{--<h3>Inputs</h3>--}}
            <form method="POST" role="form" enctype="multipart/form-data" action="{{ route('changeAdminInfo') }}">
            <div class="row">
                <div class="col-5">
                    {{--<h4>Default</h4>--}}
                        ...
                        <div class="input-group ">
                            <label style="margin-right: 1%">Name</label>
                            <input class="form-control" value="{{\Illuminate\Support\Facades\Auth::user()->name}}" name="name">
                            <span class="input-icon "></span>
                        </div>

                        <div class="input-group input-group-icon icon-right">
                            <label style="margin-right: 1% ">Email:</label>
                            {{--value="{{$contact->email}}"--}}
                            <input class="form-control" value="{{\Illuminate\Support\Facades\Auth::user()->email}}"  name="email" >
