    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content__header">
                <div>
                    <h2 class="page-content__header-heading">Rejected Competitions</h2>
                </div>
            </div>
            <div class="m-datatable">
                ...
                <table id="datatable" class="table table-striped">
                    ...
                    <tbody>
                    @foreach($rejected_competitions as $competition)
                        <tr>
                            ...
                            @if($competition->status=='rejected')
                                ...
                                <td style="width: 5%"><span class="badge badge-danger">{{$competition->status}}</span>
                                </td>
